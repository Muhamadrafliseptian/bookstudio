                        ...
                        @if (!$dataTransaksi->isEmpty())
                            @foreach ($dataTransaksi as $user)
                                <tr>
                                    ...
                                    <td>{{ $user->kode_booking == null ? "KLAIM_REWARD" : $user->payment_method }}</td>
                                    <td>{{ $user->kode_booking == null ? "REWARD" : $user->payment_channel }}</td>
                                    <td class="text-center">
                                        {{ $user->waktu_pesan }} - {{ \Carbon\Carbon::parse($user->tanggal_pesan)->translatedFormat('d F Y') }}
                                    </td>
